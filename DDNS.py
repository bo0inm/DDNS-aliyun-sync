...
def getRecord(client: Alidns20150109Client, runtime: util_models.RuntimeOptions) -> alidns_20150109_models.DescribeDomainRecordsResponse:
    """
    获取解析记录
    """
...
def changeRecord(client: Alidns20150109Client, recordID: str, recordType: str, localIP: str, runtime: util_models.RuntimeOptions) -> None:
    """ 修改阿里云解析为当下公网IP """
